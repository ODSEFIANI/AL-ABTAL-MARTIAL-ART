...
export const Contact: React.FC = () => {
  return (
    <footer
      id="contact"
      className="bg-black text-white pt-20 pb-10 border-t-4 border-accent"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Former les champions de demain à Rabat depuis 1981. Rejoignez la
              famille Al Abtal et découvrez votre potentiel.
            </p>
            <div className="flex space-x-4">
              ...
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-accent transition-colors cursor-pointer"
                >
                  <svg
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li>
                <a href="#disciplines" className="hover:text-white transition">
                  Disciplines
                </a>
              </li>
              <li>
          ...
          {/* Map Placeholder */}
          <div className="h-48 bg-gray-800 rounded-sm relative overflow-hidden">
            <iframe
              title="Google Map - Association Al Abtal"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3309.471578855586!2d-6.868932!3d34.030104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x81014f07d667bb8a!2sAssociation%20Al%20Abtal!5e0!3m2!1sen!2sma!4v1700000000000"
